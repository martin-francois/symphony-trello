...
- Treat evaluated tool, dependency, formatter, scanner, analyzer, CI gate, and wrapper-vs-premade
  decisions as ADR-worthy when more than one plausible maintained option exists. This especially
