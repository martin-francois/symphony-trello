...
[ADR 0078](0078-github-actions-continuous-fuzzing.md) so long-running fuzzing does not become part of
...
* Good, because [ADR 0078](0078-github-actions-continuous-fuzzing.md) defines the interim
