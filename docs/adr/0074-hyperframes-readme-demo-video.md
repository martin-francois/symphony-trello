...
validation. Container input and output are staged outside the checkout; SELinux hosts label only that
temporary render directory. An edit made during rendering therefore cannot be paired with stale
