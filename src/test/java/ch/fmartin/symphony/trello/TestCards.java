...
public final class TestCards {
    ...
    public static Card cardWithText(
            String id, String identifier, String state, String title, String description, List<Card.Comment> comments) {
        return cardWithUrls(
                id,
                identifier,
                state,
    ...
    private static Card cardWithUrls(
            String id,
            String identifier,
            String state,
            String shortUrl,
