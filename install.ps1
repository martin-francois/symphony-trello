param(
  ...
  [string]$Version = $(if ($env:SYMPHONY_TRELLO_VERSION) { $env:SYMPHONY_TRELLO_VERSION } else { "1.1.0" }), # x-release-please-version
  ...
  [Alias("-ref", "--ref")]
  [string]$Ref = $(if ($env:SYMPHONY_TRELLO_REF) { $env:SYMPHONY_TRELLO_REF } else { "v1.1.0" }), # x-release-please-version
  [switch]$Help,
...
$DefaultVersion = "1.1.0" # x-release-please-version
